...
float4 mainImage(VertData v_in) : TARGET
{
    ...
    {
        // We're in the border area - apply shine effect
    ...
    else
    {
        ...
        // Scale down the image to create space between image and border
        float2 scaledUV = (v_in.uv - 0.5) * 1.04 + 0.5; // 0.9 = 90% scale, adjust as needed
        ...
        {
            // In the gap between image and border - return transparent
